resource "aws_iam_role" "model_training_lambda_iam" {
  name               = var.model_training_lambda_iam_role_name
...
resource "aws_iam_role_policy_attachment" "clustering_lambda_iam_policy_attachment" {
  role = aws_iam_role.model_training_lambda_iam.name
  policy_arn = var.model_training__lambda_iam_role_arn
}
