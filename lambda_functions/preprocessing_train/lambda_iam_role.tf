resource "aws_iam_role" "preprocessing_train_lambda_iam" {
  name               = var.preprocessing_train_lambda_iam_role_name
...
resource "aws_iam_role_policy_attachment" "clustering_lambda_iam_policy_attachment" {
  role = aws_iam_role.preprocessing_train_lambda_iam.name
  policy_arn = var.preprocessing_train__lambda_iam_role_arn
}
